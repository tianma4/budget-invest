                    ...
                    <v-list>
                        <v-list-item v-for="org in organizations" :key="org.organizationId"
                            ...
                            <v-list-item-subtitle>
                                {{ tt('Role') }}: {{ org.userRole }} • {{ tt('Members') }}: {{ org.memberCount }}
                            </v-list-item-subtitle>

                            <template #append v-if="org.organizationId !== currentOrganization?.organizationId">
                                <v-btn size="small" variant="outlined" @click="switchToOrganization(org as Organization)"
                                       :disabled="loading">
                                    {{ tt('Switch') }}
                                </v-btn>
                            </template>
            ...
            <v-card :class="{ 'disabled': loading }">
                ...
                <v-card-text>
                    <div class="d-flex flex-wrap gap-3">
                        <v-btn color="primary" variant="outlined" @click="showCreateOrganizationDialog"
                               :disabled="loading" :prepend-icon="mdiPlus">
                            {{ tt('Create Organization') }}
                        </v-btn>

                        <v-btn color="secondary" variant="outlined" @click="showJoinOrganizationDialog"
                               :disabled="loading" :prepend-icon="mdiAccountPlus">
